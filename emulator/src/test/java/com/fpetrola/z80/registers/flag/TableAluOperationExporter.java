...
/** Exports a TableAluOperation's int[] table to JSON, and compares it back, for regression checks. */
public class TableAluOperationExporter {
  ...
  /**
   * @param operation      table-backed ALU operation to export
   * @param operationName  descriptive name (e.g. "RLA", "SLA", "RLC")
  ...
  /** Compares two tables by MD5 (fast) and returns the differences found. */
