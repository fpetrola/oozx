...
public class CpuVerifierImpl extends CpuVerifier {
  ...
  public void checkRegisterPair(int registerPair, int value) {
    ...
    switch (registerPair) {
      case 0:
        realValue = cpu.ooz80.getState().getRegister(RegisterName.BC).read();
        break;
      case 1:
        realValue = cpu.ooz80.getState().getRegister(RegisterName.DE).read();
        break;
      case 2:
        realValue = cpu.ooz80.getState().getRegister(RegisterName.HL).read();
        break;
      case 3:
        realValue = cpu.ooz80.getState().getRegister(RegisterName.SP).read();
        break;
      default:
  ...
  public void checkRegisterPair2(int registerPair, int value) {
    ...
    switch (registerPair) {
      case 0:
        realValue = cpu.ooz80.getState().getRegister(RegisterName.BCx).read();
        break;
      case 1:
        realValue = cpu.ooz80.getState().getRegister(RegisterName.DEx).read();
        break;
      case 2:
        realValue = cpu.ooz80.getState().getRegister(RegisterName.HLx).read();
        break;
      case 3:
        realValue = cpu.ooz80.getState().getRegister(RegisterName.SP).read();
        break;
  ...
  public void checkIX(int value) {
    ...
    int ix = cpu.ooz80.getState().getRegister(RegisterName.IX).read();
    assertEquals(
  ...
  public void checkIY(int value) {
    value &= 0xFFFF;
    int iy = cpu.ooz80.getState().getRegister(RegisterName.IY).read();
  ...
  public void checkPC(int PC) {
    int pc = cpu.ooz80.getState().getPc().read();
    assertEquals(
  ...
  public void checkI(int value) {
    int i = cpu.ooz80.getState().getRegister(RegisterName.I).read();
    assertEquals(
  ...
  public void checkR(int value) {
    int r = cpu.ooz80.getState().getRegister(RegisterName.R).read();
    assertEquals(
