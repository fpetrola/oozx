...
public class MemoryForOpcodes implements Memory {
  ...
  /**
   * Which addresses have been cached since the last reset, so that only they are thrown away.
   * It grows on demand: an instruction is four bytes at most, but bytecode generation walks
   * through many of them before resetting anything.
   */
