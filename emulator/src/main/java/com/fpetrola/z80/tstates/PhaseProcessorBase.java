...
import com.fpetrola.z80.tstates.Contention.Base;
import com.fpetrola.z80.tstates.Contention.Kind;
import com.fpetrola.z80.tstates.Contention.Moment;
...
import static com.fpetrola.z80.tstates.Contention.Kind.*;
import static com.fpetrola.z80.tstates.Contention.Moment.*;
...
public abstract class PhaseProcessorBase implements InstructionVisitor<java.lang.Integer>, ExecutionListener {
  ...
  private final Function<Instruction, Contention[]> planner = this::contentionOf;
  ...
  public void beforeExecution(Instruction instruction) {
    current = plans.computeIfAbsent(instruction, planner);
    reads = 0;
    writes = 0;
