...
public class DefaultRegisterBankFactory {
  ...
  /**
   * The fast path writes the data field directly, so it only applies when neither half overrides
   * Register's contract; RRegister, spy wrappers and virtual registers need the polymorphic path.
   */
