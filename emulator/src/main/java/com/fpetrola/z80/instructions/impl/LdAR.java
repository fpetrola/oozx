...
public class LdAR extends Ld {
  /**
   * LD A,R sets sign/zero from the loaded value, clears half-carry/subtract, sets P/V from IFF2
   * and keeps carry. F already holds the caller's real flags on entry and must not be reassigned
   * here, matching LdAI.
   */
