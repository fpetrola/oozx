...
import com.fpetrola.z80.registers.flag.AluOperationBase;

public class ProcessorUtils extends AluOperationBase {

  public static int[] compressParameters(int v1, int v2, int temp, int f) {
    int packed = 0;
  ...
  /**
   * Descomprime el valor de 16 bits y restaura la estructura para el lookup.
   */
