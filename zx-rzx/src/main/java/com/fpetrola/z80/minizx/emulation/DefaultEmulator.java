...
public class DefaultEmulator implements Emulator {
  ...
  public void setup(OOZ80 ooz80, int emulateUntil1, int pause1, Predicate<Integer> continueEmulation, Predicate<Integer> interruptionCondition) {
    this.ooz80 = ooz80;
    ...
    ObservableRegister registerR = (ObservableRegister) ooz80.getState().getRegisterR();
