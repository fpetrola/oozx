...
public class SpritesBrowserDialog extends javax.swing.JPanel
{
    ...
    private PixelView hexView;
    private Memory memory;
    private MachineTypes spectrumModel;
    private String formatInfo;

    /** Creates new form MemoryBrowser */
    public SpritesBrowserDialog(Memory memory)
    {
	initComponents();
	this.memory= memory;
	hexView= new PixelView();
...
//	informationPanel.add(filler5);
	...
	button1.addActionListener(new ActionListener()
	{
	    ...
	    {
		hexView.deltaPosition++;
	    }
	});
	informationPanel.add(button1);
...
//	add(closePanel);
    ...
    private void gotoAddressStateChanged(javax.swing.event.ChangeEvent evt)
    {// GEN-FIRST:event_gotoAddressStateChanged
    ...
    private void memoryComboBoxActionPerformed(java.awt.event.ActionEvent evt)
    {// GEN-FIRST:event_memoryComboBoxActionPerformed
    ...
    private void addressLabelMouseClicked(java.awt.event.MouseEvent evt)
    {// GEN-FIRST:event_addressLabelMouseClicked
	hexView.setAddressMode(hexView.getAddressMode() == PixelView.AddressMode.HEXADECIMAL ? PixelView.AddressMode.DECIMAL : PixelView.AddressMode.HEXADECIMAL);
    }// GEN-LAST:event_addressLabelMouseClicked

    private void markPrintableCharactersActionPerformed(java.awt.event.ActionEvent evt)
    {// GEN-FIRST:event_markPrintableCharactersActionPerformed
	if (markPrintableCharacters.isSelected())
	{
	    SwingUtilities.invokeLater(new Runnable()
	    {
