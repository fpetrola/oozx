...
public class JSpeccy extends javax.swing.JFrame
{
    ...
    private SpritesBrowserDialog spritesBrowserDialog;
	...
	JOptionPane.showMessageDialog(getContentPane(), bundle.getString("ABOUT_MESSAGE"), bundle.getString("ABOUT_TITLE"), JOptionPane.INFORMATION_MESSAGE, new javax.swing.ImageIcon(getClass().getResource("/icons/JSpeccy64x64.png")));
