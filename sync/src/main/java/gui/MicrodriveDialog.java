...
public class MicrodriveDialog extends JPanel {
    ...
    private void initComponents() {
        ...
        driveNumber = new JMenuItem();
        jSeparator1 = new JPopupMenu.Separator();
        newCartridge = new JMenuItem();
        openCartridge = new JMenuItem();
        ejectCartridge = new JMenuItem();
        saveCartridge = new JMenuItem();
        saveAsCartridge = new JMenuItem();
        jPanel1 = new JPanel();
        jScrollPane1 = new JScrollPane();
        microdrivesTable = new JTable();
        messageLabelPanel = new JPanel();
        messageLabel = new JLabel();
        jPanel2 = new JPanel();
        filler1 = new Box.Filler(new Dimension(0, 0), new Dimension(0, 0), new Dimension(32767, 0));
        closeButton = new JButton();
        filler2 = new Box.Filler(new Dimension(25, 25), new Dimension(25, 25), new Dimension(25, 25));
        ...
        microdrivesTable.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        ...
        messageLabelPanel.setPreferredSize(new Dimension(473, 50));
