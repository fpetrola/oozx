...
public class DivMmcDevices extends AbstractModule implements Extension {
  protected void configure() {
    com.fpetrola.oozx.config.Settings.mirror(binder(), "divmmc", DivMmcPeripheral.class, "writeProtect");
