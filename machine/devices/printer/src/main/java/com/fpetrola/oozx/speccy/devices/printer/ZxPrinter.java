 ...
 * the arithmetic is the hardware's, with its constants kept exactly - 440
 ...
 * <p>
 * Where a frame counter and a within-frame t-state count would have to be added up at every
...
public class ZxPrinter {
  ...
  /** Feeding stops after this much of nothing, so an idle printer does not make miles of blank paper. */
