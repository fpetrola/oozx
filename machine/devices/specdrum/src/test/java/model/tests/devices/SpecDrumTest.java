...
class SpecDrumTest {
  ...
  void aByteWrittenToItsPortIsHeard() {
    ...
    SpecDrumPeripheral box = (SpecDrumPeripheral) speccy.peripherals.find(SpecDrumPeripheral.class);
    box.plugIn(true);
    speccy.peripherals.update();
    assertTrue(speccy.peripherals.isActive(SpecDrumPeripheral.class));
    ...
    speccy.peripherals.writePort(0xdf, (byte) 0xff);
