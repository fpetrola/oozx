...
public class SpecPlus2A extends SpecPlus3 {
  @Inject
  public SpecPlus2A(Memory memory, Display display, PeripheralBusDelegate peripherals, Settings settings, EventManager eventManager, Cpu cpu, Timer timer, Module module, UPDFdc uPDFdc1, Sound sound, UserInterface userInterface) {
