...
public class MemoryState {
    ...
    /**
     * A byte of a page, for the Z80 writer's compression. A page a snapshot did not carry reads
     * as zeros, which is what a machine has in RAM it never wrote to; asking for it used to throw.
     */
