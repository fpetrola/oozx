...
//                                    z80Header2[2]));
  ...
  /**
   * What libspectrum gives a header that carries no counter - a v1, or a v2 - and what this
  ...
  /**
   * The counter a .z80 keeps in its extended header, as libspectrum reads and writes it: which
