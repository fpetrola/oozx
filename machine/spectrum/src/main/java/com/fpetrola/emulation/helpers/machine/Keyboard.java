...
public class Keyboard implements KeyListener {
  ...
  private final JoystickRaw joystick2;
    ...
    public void keyPressed(KeyEvent evt) {
        ...
        // Windows never sends VK_ALT_GRAPH: it reports Ctrl then Alt instead, and the Ctrl
        // half of that pair registers as Symbol Shift, which must be undone here.
    ...
    public void keyReleased(KeyEvent evt) {
        ...
        // Same Windows Ctrl+Alt-for-AltGr substitution as in keyPressed.
