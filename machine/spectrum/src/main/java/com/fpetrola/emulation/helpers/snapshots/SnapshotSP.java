...
public class SnapshotSP implements SnapshotFile {
    ...
    public SpectrumState load(File filename) throws SnapshotException {
        ...
        try {
            ...
            // Header bytes 32-33 and 35 carry nothing the format defines.
            ...
            // Header byte 37 carries nothing the format defines either.
            ...
            // SP has no field for issue-2 or joystick model either.
