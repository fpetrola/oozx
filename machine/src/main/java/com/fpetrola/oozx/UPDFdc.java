...
//        Event.init();
    ...
    // Allocate an FDC
    public static UPDFdc allocFdc(UpdType type, UpdClock clock) {
        UPDFdc fdc = new UPDFdc();
        fdc.type = type;
        fdc.clock = clock;
        return fdc;
    }
    ...
    public static void masterReset(UPDFdc fdc) {
    ...
    // Read FDC status
    public static byte readStatus(UPDFdc fdc) {
        // Placeholder for reading status
        return fdc.mainStatus;
    }

    // Read FDC data
    public static byte readData(UPDFdc fdc) {
        // Placeholder for reading data
        return fdc.dataRegister[0];
    }

    // Write FDC data
    public static void writeData(UPDFdc fdc, byte b) {
