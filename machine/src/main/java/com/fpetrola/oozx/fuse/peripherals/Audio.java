...
public class Audio {
  ...
  public Audio(AY8912Type ayConf) {
    settings = ayConf;
    line = null;
  }

  public synchronized void open(MachineTypes model, AY8912 ay8912, boolean hasAY, int freq) {
...
//                System.out.println(fmt);
        ...
        System.out.println("Unavailable Line: " + excpt);
      }
...
//                    samplingFrequency, samplesPerFrame, frameSize));
      ...
      try {
        ...
        System.out.println("Unavailable Line: " + ex);
      }
    }
  }
  ...
  public synchronized void updateAudio(int tstates, int value) {
