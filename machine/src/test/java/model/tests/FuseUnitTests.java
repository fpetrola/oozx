...
//        ula.setScreenActive(true);
    ...
    private int unittests_assert_16k_ram_page(int base, int page) { return unittests_assert_16k_page(base, memory.sourceRam, page); }
