...
public class JetSetWilly2Converted {
    ...
    public static IO<WordNumber> io;
    ...
    public void init() {
        ...
        for (int i = 0; i < 65536; ++i) {
            mem[i] = (i < 16384 ? MiniZXWithEmulationBase.createROM()[i] : MiniZXWithEmulationBase.gzipDecompressFromBase64(this.getProgramBytes())[i]) & 0xff;
        }
    }
    ...
    public int[] _rl(int a, int f) {
        f = (a & 128) >> 7;
        return new int[]{ ((a << 1) & 0xfe) | (f & 0x1), f };
    }
