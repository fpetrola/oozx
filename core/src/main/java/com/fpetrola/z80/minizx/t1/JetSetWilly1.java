...
public class JetSetWilly1 extends MiniZX {
               ...
               while(true) {
                  label306: {
                     ...
                     if(F == 0) {
                        IX(34175);
                        int var226 = IX() + 4;
                        int var227 = mem[var226] + 1 & 255;
                        mem[var226] = var227;
                        int var228 = IX() + 4;
                        int var229 = mem[var228];
                        A = var229;
                        if(A == 58) {
                           int var230 = IX() + 4;
                           mem[var230] = 48;
                           int var231 = IX() + 3;
                           int var232 = mem[var231] + 1 & 255;
                           mem[var231] = var232;
                           int var233 = IX() + 3;
                           ...
                           if(A == 54) {
                              ...
                              mem[var235] = 48;
                              int var236 = IX();
                              int var237 = mem[var236];
                              A = var237;
                              if(A == 49) {
                                 int var244 = IX() + 1;
                                 int var245 = mem[var244] + 1 & 255;
                                 mem[var244] = var245;
                                 int var246 = IX() + 1;
                                 ...
                                 int var238 = IX() + 1;
                                 int var239 = mem[var238] + 1 & 255;
                                 mem[var238] = var239;
                                 int var240 = IX() + 1;
                                 int var241 = mem[var240];
                                 A = var241;
                                 if(A == 58) {
                                    int var242 = IX() + 1;
                                    mem[var242] = 48;
                  ...
                  int var158 = mem[34275];
                  A = var158;
                  if(A != 10) {
                     int var159 = mem[33824];
                     A = var159;
                     if(A == 28) {
                        int var160 = mem[34255];
                        A = var160;
                        if(A == 208) {
                           int var161 = mem[34275];
                           A = var161;
                           int var162 = A;
         ...
         label213: {
            label228: {
               ...
               if((A & 128) != 0) {
                  ...
                  HL(var204);
                  if((H & 2) != 0) {
                     int var205 = mem[33004];
                     A = var205;
                     mem[33824] = A;
                     A = 0;
                     mem[34255] = A;
                     int var206 = mem[34257];
                     A = var206;
                     if(A < 11) {
                        A = 2;
                        mem[34257] = A;
            ...
            int var182 = mem[34257];
            A = var182;
            if(A != 1) {
               HL(34256);
               int var183 = HL();
               int var184 = mem[var183] & -3;
               int var185 = HL();
               mem[var185] = var184;
               int var186 = mem[34257];
               A = var186;
               if(A << 1 == 0) {
                  A = 2;
                  mem[34257] = A;
         ...
         if(A << 1 != 0) {
            if(A != 3) {
               if(A != 4) {
                  ...
                  if((mem[var113] & 128) == 0) {
                     int var162 = IX() + 4;
                     int var163 = mem[var162] - 1 & 255;
                     mem[var162] = var163;
                     C = 44;
                  } else {
                     int var114 = IX() + 4;
                     int var115 = mem[var114] + 1 & 255;
                     mem[var114] = var115;
                     C = 244;
                  }
                  ...
                  if(A != C) {
                     ...
                     if(A << 1 == 0) {
                        ...
                        mem[var130] = 0;
                        int var131 = HL();
                        int var132 = mem[var131];
                        A = var132;
                        int var133 = A & 7;
                        A = var133;
                        if(A == 7) {
                           int var156 = IX() + 5;
                           int var157 = mem[var156] - 1 & 255;
                           mem[var156] = var157;
                        }
