...
//    translateToJava("ZxGame1", base64Memory, "$61483");
  ...
  // Disabled: symbolic execution already finds 24 of the 26 expected routines by
  // itself, but the bytecode generator still throws a NullPointerException while
  // emitting code, and the expected MD5s predate these tests being turned off in 2024.
  @Ignore
  @Test
