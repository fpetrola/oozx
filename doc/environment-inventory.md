...
- `doc/`: `configuracion.json`, `plan-configuracion.md`, `plan-modulos.md`,
...
- **No measurement of the reference emulator or ZXSpin exists in the repository.** The first line of
  ...
  "advantages over the reference emulator" are reasoned from reading it rather than measured; the third (dirty
...
- The stub of a reference library goes, and with it the snapshot path nothing ever walked
