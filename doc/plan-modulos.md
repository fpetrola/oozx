...
| `speccy/screen` + `SpeccyScreen`, `TvScreen`, `SpectrumPanel` | 12 | la pantalla dibujada |
...
- Los dispositivos se descubren por classpath (`Extension` + `ServiceLoader`), no por una lista.
