...
También conviene tener presente que la batería de vectores, con 1356 casos, tiene **un vector por
opcode**: alcanza para encontrar una instrucción rota de arriba abajo, no una que acierta en ese
vector y falla en el resto. Las cuatro fallas encontradas acá pasaban la batería.
