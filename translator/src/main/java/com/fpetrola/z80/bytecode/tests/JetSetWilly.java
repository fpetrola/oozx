...
public class JetSetWilly extends MiniZX {
            ...
            while(true) {
              label363: {
                ...
                if(F() == 0) {
                  ...
                  pc(35414, 2);
                  int var305 = IX() + 4;
                  int var306 = mem[var305] + 1 & 255;
                  mem[var305] = var306;
                  F(var306);
                  pc(35417, 2);
                  int var307 = IX() + 4;
                  int var308 = mem[var307];
                  A(var308);
                  pc(35420, 1);
                  int var309 = A() - 58;
                  F(var309);
                  ...
                  if(F() == 0) {
                    ...
                    pc(35428, 2);
                    int var311 = IX() + 3;
                    int var312 = mem[var311] + 1 & 255;
                    mem[var311] = var312;
                    F(var312);
                    pc(35431, 2);
                    int var313 = IX() + 3;
                    int var314 = mem[var313];
                    A(var314);
                    pc(35434, 1);
                    int var315 = A() - 54;
                    F(var315);
                    ...
                    if(F() == 0) {
                      ...
                      if(F() == 0) {
                        pc(35449, 2);
                        int var327 = IX() + 1;
                        int var328 = mem[var327] + 1 & 255;
                        mem[var327] = var328;
                        F(var328);
                        pc(35452, 2);
                        int var329 = IX() + 1;
                        int var330 = mem[var329];
                        A(var330);
                        pc(35455, 1);
                        int var331 = A() - 51;
                        F(var331);
                        ...
                        pc(35481, 2);
                        int var320 = IX() + 1;
                        int var321 = mem[var320] + 1 & 255;
                        mem[var320] = var321;
                        F(var321);
                        pc(35484, 2);
                        int var322 = IX() + 1;
                        int var323 = mem[var322];
                        A(var323);
                        pc(35487, 1);
                        int var324 = A() - 58;
                        F(var324);
              ...
              if(F() != 0) {
                pc(35628, 2);
                int var289 = HL();
                int var290 = mem[var289] & 1;
                F(var290);
                pc(35630, 1);
                if(F() == 0) {
                  pc(35632, 1);
                  int var291 = HL();
                  int var292 = mem[var291];
                  A(var292);
                  pc(35633, 1);
                  int var293 = A() ^ 3;
                  A(var293);
  ...
  public void $36203() {
    ...
    if(F() != 0) {
      pc(36246, 1);
      int var46 = (mem[32983 + 1] << 8) + mem[32983];
      HL(var46);
      pc(36249, 1);
      B(A());
      pc(36250, 1);
    ...
    if(F() != 0) {
      pc(36262, 1);
      int var32 = (mem[32987 + 1] << 8) + mem[32987];
      HL(var32);
      pc(36265, 1);
      int var33 = mem[32986];
      A(var33);
  ...
  public void $36307() {
    label213: {
      label226: {
        ...
        if(F() != 0) {
          label223: {
            ...
            if(F() == 0) {
              ...
              $36508();
              pc(36343, 1);
              int var332 = mem[32946];
              A(var332);
              pc(36346, 1);
              int var333 = HL();
              int var334 = mem[var333];
              int var335 = A() - var334;
              F(var335);
              pc(36347, 1);
              if(F() == 0) {
            ...
            if(F() == 0) {
              pc(36413, 1);
              int var293 = (mem[34259 + 1] << 8) + mem[34259];
              HL(var293);
              pc(36416, 1);
              DE(64);
              pc(36419, 1);
              ...
              pc(36425, 1);
              int var304 = mem[32955];
              A(var304);
              pc(36428, 1);
              int var305 = HL();
              int var306 = mem[var305];
              int var307 = A() - var306;
              F(var307);
              pc(36429, 1);
              if(F() != 0) {
                ...
                if(F() != 0) {
                  pc(36438, 1);
                  int var313 = mem[32928];
                  A(var313);
                  pc(36441, 1);
                  int var314 = HL();
                  int var315 = mem[var314];
                  int var316 = A() - var315;
                  F(var316);
                  pc(36442, 1);
        ...
        if(F() != 0) {
          label225: {
            ...
            mem[34257] = value;
            pc(36586, 1);
            int var252 = mem[32973];
            A(var252);
            pc(36589, 1);
            int var253 = HL();
            int var254 = mem[var253];
            int var255 = A() - var254;
            F(var255);
            pc(36590, 1);
            if(F() != 0) {
      ...
      if(F() != 0) {
        ...
        if(F() == 0) {
          pc(36838, 1);
          int var204 = (mem[34259 + 1] << 8) + mem[34259];
          HL(var204);
          pc(36841, 1);
          BC(0);
          pc(36844, 1);
          int var205 = mem[32986];
          A(var205);
          pc(36847, 1);
          int var206 = A() - 1 & 255;
          A(var206);
        ...
        pc(36874, 1);
        int var159 = (mem[34259 + 1] << 8) + mem[34259];
        HL(var159);
        pc(36877, 1);
        A(L());
        pc(36878, 1);
        ...
        pc(38026, 1);
        int var162 = mem[33001];
        A(var162);
        pc(38029, 1);
        int value1 = A();
        mem[33824] = value1;
        pc(38032, 1);
        int var163 = mem[34259];
        A(var163);
        pc(38035, 1);
        int var164 = A() | 31;
        A(var164);
      ...
      if(F() == 0) {
        ...
        HL(var147);
        pc(36966, 1);
        int var148 = mem[32964];
        A(var148);
        pc(36969, 1);
        int var149 = HL();
        int var150 = mem[var149];
        int var151 = A() - var150;
        F(var151);
        pc(36970, 1);
        if(F() == 0) {
      ...
      pc(36984, 1);
      int var89 = (mem[34259 + 1] << 8) + mem[34259];
      HL(var89);
      pc(36987, 1);
      int var90 = BC();
      ...
      if(F() != 0) {
        ...
        if(F() != 0) {
          ...
          if(F() != 0) {
            ...
            pc(37431, 2);
            int var144 = IX() + 0;
            int var145 = mem[var144] & 128;
            F(var145);
            pc(37435, 1);
            if(F() == 0) {
              pc(37437, 2);
              int var204 = IX() + 4;
              int var205 = mem[var204] - 1 & 255;
              mem[var204] = var205;
              F(var205);
              pc(37440, 1);
              C(44);
            ...
            if(F() != 0) {
              ...
              if(F() == 0) {
                ...
                pc(37484, 1);
                int var155 = DE();
                int var156 = mem[var155];
                A(var156);
                pc(37485, 2);
                int var157 = IX() + 4;
                int var158 = mem[var157];
                int var159 = A() + var158;
          ...
          while(true) {
            ...
            if(F() != 0) {
              ...
              if(F() != 0) {
                while(true) {
                  ...
                  pc(37684, 2);
                  int var113 = IX() + 5;
                  int var114 = mem[var113] & 1;
                  F(var114);
                  pc(37688, 1);
                  if(F() != 0) {
                    pc(37690, 2);
                    int var116 = IX() + 3;
                    int var117 = mem[var116] - 1 & 255;
                    mem[var116] = var117;
                    F(var117);
                  }
                ...
                do {
                  ...
                  pc(37701, 2);
                  int var105 = IX() + 5;
                  int var106 = mem[var105] & 128;
                  F(var106);
                  pc(37705, 1);
                  if(F() != 0) {
                    pc(37707, 2);
                    int var108 = IX() + 3;
                    int var109 = mem[var108] + 1 & 255;
                    mem[var108] = var109;
                    F(var109);
                  }
            ...
            if(F() == 0) {
              ...
              if(F() != 0) {
                ...
                pc(37737, 2);
                int var96 = IX() + 11;
                int var97 = mem[var96] & -2;
                mem[var96] = var97;
                pc(37741, 1);
              } else {
                pc(37743, 2);
                int var56 = IX() + 11;
                int var57 = mem[var56] & 1;
                F(var57);
                pc(37747, 1);
                if(F() != 0) {
                  pc(37749, 1);
  ...
  public void $38344() {
    ...
    pc(38392, 1);
    int var13 = (mem[34259 + 1] << 8) + mem[34259];
    HL(var13);
    pc(38395, 1);
    DE(31);
    pc(38398, 1);
