...
//    for (int i = 16384; i < 65520; i++)
  ...
  protected void main() {
    ...
    DefaultRegisterBankFactory defaultRegisterBankFactory = new DefaultRegisterBankFactory();
    state = new State(new MockedIO(), defaultRegisterBankFactory.createBank(), new MockedMemory(true));
